...
const HeroSection: React.FC = () => {
  ...
  return (
    <section id="hero" className="min-h-screen flex items-center pt-16 bg-white dark:bg-gray-900 transition-colors duration-300">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-10">
          ...
          >
            ...
            <div className="typing-container mb-6">
              <h2 className="text-xl md:text-2xl text-gray-600 dark:text-gray-300">
                4th Year CSE Student | Full Stack Developer | DSA Enthusiast
              </h2>
            </div>
            <p className="text-gray-600 dark:text-gray-300 mb-8 max-w-lg animate-slide-in">
            I’m an enthusiastic and adaptable Full Stack Developer with a solid foundation in C++ and hands-on experience in 3D design tools. I love building accessible and user-friendly web applications as well as utility-driven solutions that simplify everyday problems. With a natural curiosity and passion for learning, I constantly explore new technologies, refine my skills, and take on challenges that help me grow while contributing to dynamic, fast-paced tech environments.            </p>
          ...
          >
            <div className="relative">
              ...
              <div className="w-64 h-64 md:w-80 md:h-80 bg-blue-100 dark:bg-blue-900/30 rounded-full overflow-hidden border-4 border-white dark:border-gray-700 shadow-xl relative animate-pulse">
                <img 
