    ...
    <section id="contact" className="py-20 bg-white dark:bg-gray-900 transition-colors duration-300">
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-16 animate-fade-in">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-blue-900 dark:text-white">Get In Touch</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <div className="animate-slide-in" style={{ animationDelay: "200ms" }}>
            <div className="bg-blue-50 dark:bg-gray-800 rounded-lg p-8 h-full shadow-md hover:shadow-lg transition-all duration-300">
              <h3 className="text-xl font-bold mb-6 text-blue-800 dark:text-blue-400">Contact Information</h3>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <a href="mailto:john.doe@example.com" className="text-blue-500 dark:text-blue-400 hover:underline hover:text-blue-700 dark:hover:text-blue-300 transition-colors">
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <a href="tel:+1234567890" className="text-blue-500 dark:text-blue-400 hover:underline hover:text-blue-700 dark:hover:text-blue-300 transition-colors">
                      +91 9729567273
                    </a>
                  </div>
                </div>
                ...
                <div className="pt-6">
                  <h4 className="font-semibold mb-4 text-gray-900 dark:text-gray-100">Connect With Me</h4>
